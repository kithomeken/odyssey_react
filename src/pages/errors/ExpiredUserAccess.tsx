...
export const ExpiredUserAccess = () => {
    ...
    return (
        <React.Fragment>
            <Helmet>
                <title>Account Access Expired</title>
            </Helmet>
                ...
                <section className="gx-container">
                    <div className="space-y-3 shadow-none border-0 border-slate-300 px-10 mb-3">
                        <div className="w-12/12 pb-4 pt-10 m-auto">
                            <img src={emptyBox} alt="401_broken_robot" width="200px" className="block text-center m-auto" />
                        </div>
                        ...
                        <div className="m-auto">
                            ...
                            <p className="text-sm text-center form-group mb-0 text-gray-600">
                                Kindly contact your system administrator to extend your account access
                            </p>
                        </div>
                    </div>
