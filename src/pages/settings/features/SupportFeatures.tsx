            ...
            <div className="w-full form-group">
                <div className="w-12/12">
                    <p className="text-sm form-group text-gray-500">
                        We have a tonne of support features available on {applicationName} that help us tailor the system to your exact needs. Unfortunately, not all may be applicable to you or your users. And as such, to best suit your workflow experience and performance, select all support features that may apply to your business flow.
                    </p>
                </div>
