...
export default class SignIn extends Component<RouteComponentProps> {
    ...
    async sanctumAuthentication() {
        ...
        const postResponse = await AuthServices.doUserSignIn(postData)
        console.log(postResponse)

        if (postResponse.success) {
            AuthServices.handleSuccessfulSignIn(postResponse)
                        ...
                        <form className="space-y-3 shadow-none px-10 form-group">
                            <div className="rounded-md shadow-none -space-y-px">
                                ...
                                <div className="form-group">
                                    ...
                                    <input id="password" name="password" type="password" autoComplete="current-password" required className="auth-password-input" placeholder="********" value={this.state.input.password} onChange={(event) => this.setState({ 
                                        input: {
