...
export const accountRoutes = [
    ...
    /* 1 */ { path: "/a/default/settings/user-accounts/agent-accounts", element: <AgentAccounts />, activeMenu: 'master', name: 'AGNT' },
    /* 1 */ { path: "/a/default/settings/user-accounts/agent-accounts/:uuid", element: <AgentDetails />, activeMenu: 'master', name: 'AGNT' },
