...
export const TopHeader: FC<Props> = ({ showSettings = true, showNotifications = true }) => {
                                    ...
                                    <div className="p-1 ml-3 rounded hover:text-slate-700 focus:outline-none focus:ring-0 focus:ring-offset-2 focus:ring-white">
                                        <Menu as="div" className="relative inline-block text-left float-right">
                                            <div className='flex flex-row w-full'>
                                                <Menu.Button
                                                    onClick={showOrHideMenuSettings}
                                                    className={
                                                        classNames(
                                                            state.show.setting ? 'bg-slate-200 text-slate-700' : null,
