                                    ...
                                    actionButton ? (
                                        ...
                                        <div className="mt-5 flex lg:mt-0 lg:ml-4">
                                            <span className="hidden sm:block">
                                                <button type="button" onClick={actionEvent} className={`inline-flex items-center px-4 py-1-5 border-2 border-green-600 rounded shadow-sm text-sm text-green-700 hover:border-green-800 hover:text-green-800 focus:outline-none focus:ring focus:ring-offset-2 focus:ring-green-400`}>
